...
?>
                ...
                <div class="col-sm-7 add-bs" style="margin: 0 auto">
                    <div class="p-3 card stacked-form">
                        ...
                        <div class="card-header mb-4">
                            <h4 class="card-title">Add SubNews</h4>
                        </div>
                        <form>
                            <div class="form-group">
                                <label for="subnews_name">SubNews name</label>
                                <input type="text" class="form-control" id="subnews_name" placeholder="SubNews name" value="<?= $res_row ? $row_this['subnews_name'] : '' ?>">
                            </div>
   ...
   <script src="../my_js/update_subnews.js"></script>
