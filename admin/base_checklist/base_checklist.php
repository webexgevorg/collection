                            ...
                            <div class="card data-tables">
                                <div class="card-body table-striped table-no-bordered table-hover dataTable dtr-inline table-full-width">
                                    ...
                                    <div class="fresh-datatables">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%" data-tblname='base_checklist'>
                                            <thead>
                                                <tr>
                                                     <th>#</th>
                                                    <th class='th' data-name='card_number'>CARD NUMBER</th>
                                                    <th class='th' data-name='card_name'>CARD NAME</th>
                                                    <th class='th' data-name='team'>TEAM</th>
                                                    <th class='th' data-name='set_type'>SET TYPE</th>
                                                    <th class='th' data-name='parallel'>PARALLEL</th>
                                                    <th class='th' data-name='print_run'>PRINT RUN</th>
