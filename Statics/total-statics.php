...
//    }
    ...
    $users_users_mounth_number = "SELECT login_date FROM `users` WHERE login_date  >= NOW() - INTERVAL 1 Month";
    ...
    $active_users_mounth_number_result = mysqli_query($con, $users_users_mounth_number);
